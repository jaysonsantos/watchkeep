      ...
      : [
          {
            ...
            note: "Closest to the genres you watch.",
            linked: false,
          ...
          },
          {
            ...
            note: "You watched a part of these collections.",
            linked: false,
          ...
          },
          {
            ...
            note: "You finished these and they still make episodes.",
            linked: true,
  ...
  <div>
    ...
    <p class="sub">
      {#if profile && profile.items > 0}
        From {profile.items} watched {profile.items === 1 ? "item" : "items"} in your library.
      {:else}
